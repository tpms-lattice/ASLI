...
%To discretize the implicitly defined infills the open-source library \href{https://www.cgal.org}{CGAL} or \href{https://www.mmgtools.org}{MMG} is used. \asli{} also has an optional Graphical User Interface (GUI) available, called \qasli{}, and supports parallel computing (via Intel oneAPI Threading Building Blocks).

%Details on the technical aspects of \asli{} can be found in \href{https://www.???.???}{``A flexible and easy-to-use open-source tool for designing functionally graded 3D porous structures''}
...
%\begin{itemize}
%	\item F. Perez-Boerema, M. Barzegari and L. Geris. ``\href{https://www.???.???}{A flexible and easy-to-use open-source tool for designing functionally graded 3D porous structures}'', \textit{JournalName}, 2022.
%\end{itemize}
