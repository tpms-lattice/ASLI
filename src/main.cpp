...
void show_help() {
	...
	std::cout
		...
		<< "  files -> sap                me_edgeProtectionAngle   \n"
		<< "  files -> fap                me_threshold             \n"
		<< "  files -> output             me_volumeMesh            \n"
		<< "  lt_type                     CGAL_facetDistance       \n"
		<< "  lt_type_side                CGAL_relativeErrorBound  \n"
		<< "  lt_type_filterRadius        CGAL_cellRadiusEdgeRatio \n"
		<< "  lt_type_correctionFactor    CGAL_facetAngle          \n"
		<< "  lt_size                     CGAL_facetSize           \n"
		<< "  lt_feature                  CGAL_edgeSize            \n"
		<< "  lt_feature_val              CGAL_minEdgeSize         \n"
		<< "  lt_feature_mode             MMG_hausd                \n"
		<< "  udf_feature                 MMG_hgrad                \n"
		<< "  udf_A                       MMG_hinitial             \n"
		<< "  udf_B                       MMG_exportLS             \n"
		<< "  udf_C                       verbosity                \n"
		<< "  udf_D                                                \n"
