...
enum MMG3D_Param {
  ...
  MMG3D_DPARAM_rmc,                       /*!< [-1/val], Remove small connex solid componants in level-set mode */
  MMG3D_DPARAM_rmcvoid,                   /*!< [-1/val], Remove small connex void componants in level-set mode */
